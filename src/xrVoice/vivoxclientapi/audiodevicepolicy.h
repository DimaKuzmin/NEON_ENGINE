...
public:
    enum vx_audio_device_policy {
        ...
        vx_audio_device_policy_default_communication = 2,
    };
    ...
    void SetUseDefaultSystemAudioDevice()
    {
        m_specificAudioDevice = AudioDeviceId(USE_SYSTEM_DEVICE_NAME, USE_SYSTEM_DEVICE_NAME);
        m_audioDevicePolicy = vx_audio_device_policy_default_system;
    }
    void SetUseDefaultCommunicationAudioDevice()
    {
        m_specificAudioDevice = AudioDeviceId(USE_COMMUNICATION_DEVICE_NAME, USE_COMMUNICATION_DEVICE_NAME);
        m_audioDevicePolicy = vx_audio_device_policy_default_communication;
    }
